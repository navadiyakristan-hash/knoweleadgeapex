...
import { addProduct, deleteProductById, fetchGroupedByPrice, fetchProductById, fetchProducts, undeleteProductById, updateProductById } from "./ProductApi";
...
export const fetchGroupedByPriceAsync = createAsyncThunk(
    "products/fetchGroupedByPriceAsync",
    async () => {
      const grouped = await fetchGroupedByPrice();
      return grouped;
    }
  );
...
// *  GroupFeatch by Price
            .addCase(fetchGroupedByPriceAsync.pending, (state) => {
                state.productFetchStatus = "pending";
              })
              .addCase(fetchGroupedByPriceAsync.fulfilled, (state, action) => {
                state.productFetchStatus = "fulfilled";
                state.groupedProducts = action.payload;
              })
              .addCase(fetchGroupedByPriceAsync.rejected, (state, action) => {
                state.productFetchStatus = "rejected";
                state.errors = action.error;
              })
...
export const selectGroupedProducts = (state) => state.ProductSlice.groupedProducts;
