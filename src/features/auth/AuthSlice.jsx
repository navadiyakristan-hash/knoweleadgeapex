...
export const signupAsync = createAsyncThunk('auth/signupAsync', async (cred) => {
    console.log('cred in signupAsync:', cred); // Debugging credentials in thunk
    try {
        const res = await signup(cred);
        console.log('res in signupAsync:', res); // Debugging response in thunk
        return res;
    } catch (error) {
...
export const resendOtpAsync = createAsyncThunk('auth/resendOtpAsync', async (data) => {
    console.log("Resending OTP with payload:", data);
  ...
  export const verifyOtpAsync = createAsyncThunk('auth/verifyOtpAsync', async (cred) => {
    ...
    const response = await verifyOtp(cred);
